...
public class LuckyParrot extends Animal {
    ...
    public LuckyParrot(EntityType<? extends Animal> pEntityType, Level pLevel) {
    ...
    public AgeableMob getBreedOffspring(ServerLevel pLevel, AgeableMob pOtherParent) {
        return ModEntities.LUCKY_PARROT.get().create(pLevel);
    }
