...
public class LuckyStructure extends Structure {
    ...
    public static final MapCodec<LuckyStructure> CODEC = RecordCodecBuilder.mapCodec(instance ->
            instance.group(LuckyStructure.settingsCodec(instance),
            ...
            ).apply(instance, LuckyStructure::new));
    ...
    public Optional<Structure.GenerationStub> findGenerationPoint(Structure.GenerationContext context) {
        LOGGER.info("findGenerationPoint");

        // Check if the spot is valid for our structure.
        // Returning an empty optional tells the game to skip this spot as it will not generate the structure.
        if (!LuckyStructure.extraSpawningChecks(context)) {
    ...
    public StructureType<?> type() {
        return ModStructures.LUCKY_STRUCTURE.get(); // Helps the game know how to turn this structure back to json to save to chunks
    }
}
